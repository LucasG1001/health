...
export function TrophyIcon({ className }: IconProps) {
  return (
    <Icon className={className}>
      ...
      <path d="M6 5H3a3 3 0 0 0 3 5" />
      <path d="M18 5h3a3 3 0 0 1-3 5" />
    </Icon>
  );
}
...
export function MedalIcon({ className }: IconProps) {
  return (
    <Icon className={className}>
      ...
      <path d="m8.5 10.5-3-7.5" />
      <path d="m15.5 10.5 3-7.5" />
      <path d="m12 9-2-6" />
    </Icon>
  );
}
...
export function CrownIcon({ className }: IconProps) {
  return (
    <Icon className={className}>
      <path d="m3 8 4 4 5-6 5 6 4-4-1 11H4Z" />
    </Icon>
  );
}
...
export function WeightIcon({ className }: IconProps) {
  return (
    <Icon className={className}>
      ...
      <path d="M5 8h14l1.5 12a1 1 0 0 1-1 1h-15a1 1 0 0 1-1-1Z" />
    </Icon>
  );
}
...
export function NoteIcon({ className }: IconProps) {
  return (
    <Icon className={className}>
      <path d="M5 3h14a1 1 0 0 1 1 1v12l-5 5H5a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1Z" />
      <path d="M15 21v-5h5" />
    </Icon>
  );
}
